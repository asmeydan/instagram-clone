...
const NewPost = ({ setNewPost }) => {
  return (
    <div className=' fixed top-0 bottom-0 right-0 left-0 bg-white/20 flex justify-center items-center text-white '>
        ...
        <div onClick={()=> setNewPost(false)} className=' w-[34px] h-[34px] fixed right-4 top-4 text-2xl rounded-full backdrop-opacity-60 backdrop-invert bg-white/30 flex justify-center items-center cursor-pointer '>
